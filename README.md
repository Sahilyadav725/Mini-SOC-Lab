...
<!-- Active Response Execution Trigger -->
<active-response>
...
```
@echo off
del /f /q "C:\Users\Public\Downloads\eicar*"
```
...
​🔹 1. Real-Time File Integrity Monitoring (FIM) Dashboard
​Visualizing real-time file creation alerts for eicar.txt on the Win11-Endpoint agent.

<img width="973" height="590" alt="WhatsApp Image 2026-07-29 at 2 17 57 PM" src="https://github.com/user-attachments/assets/834b46fa-62c7-4632-baa1-cf90e80000ed" />


​🔹 2. Endpoint Vulnerability Detector Dashboard
​Automated auditing identifying High and Medium severity CVEs across endpoint software.

<img width="978" height="519" alt="WhatsApp Image 2026-07-29 at 2 18 22 PM" src="https://github.com/user-attachments/assets/90e8d589-e3d1-4bd3-8e9c-87d780b49dda" />
